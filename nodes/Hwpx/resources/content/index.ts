		...
		options: [
			{
				name: '텍스트 치환',
				value: 'replaceText',
				description: 'HWPX 문서의 텍스트를 치환합니다 (ZIP 레벨 치환)',
				action: '문서의 텍스트를 치환합니다',
			},
			{
				name: '순차 텍스트 치환',
				value: 'replaceTextSequential',
				description:
					'플레이스홀더의 각 출현을 순서대로 다른 값으로 치환합니다',
				action: '문서의 텍스트를 순차적으로 치환합니다',
			},
			{
				name: '구조 추출',
				value: 'extractStructure',
				description: 'HWPX 문서에서 텍스트 내용과 구조를 추출합니다',
				action: '문서에서 구조를 추출합니다',
			},
			{
				name: '텍스트 목록',
				value: 'listTexts',
				description:
					'HWPX 문서의 모든 텍스트 요소를 나열합니다 (플레이스홀더 탐색에 유용)',
				action: '문서의 모든 텍스트를 나열합니다',
			},
			{
				name: '페이지 설정',
				value: 'pageSetup',
				description: 'HWPX 문서의 페이지 크기, 방향, 여백을 수정합니다',
				action: '페이지 레이아웃을 설정합니다',
			},
			{
				name: '이미지 삽입',
				value: 'insertImage',
				description: 'HWPX 문서에 이미지를 삽입합니다',
				action: '문서에 이미지를 삽입합니다',
			},
			{
				name: '표 추가',
				value: 'addTable',
				description: 'JSON 데이터로 HWPX 문서에 표를 추가합니다',
				action: '문서에 표를 추가합니다',
			},
			{
				name: '머리글/바닥글 설정',
				value: 'setHeaderFooter',
				description: 'HWPX 문서에 머리글 및/또는 바닥글 텍스트를 설정합니다',
				action: '머리글 또는 바닥글 텍스트를 설정합니다',
			},
			{
				name: '셀 병합',
				value: 'mergeCells',
				description: 'HWPX 문서 내 기존 표의 셀을 병합합니다',
				action: '표 셀을 병합합니다',
			},
			{
				name: '수식 삽입',
				...
				description:
					'한컴 수식 스크립트 구문을 사용하여 수학 수식을 삽입합니다 (LaTeX 아님)',
				action: '수학 수식을 삽입합니다',
			},
			{
				name: '단 레이아웃',
				value: 'setColumnLayout',
				description: '다단 레이아웃을 설정합니다 (2단 신문형 등)',
				action: '단 레이아웃을 설정합니다',
			},
			{
				name: '단 나누기',
				value: 'insertColumnBreak',
				description:
					'섹션 내에서 다음 단으로 전환하기 위한 단 나누기를 삽입합니다',
				action: '단 나누기를 삽입합니다',
			},
			{
				name: '시험지 머리글 서식',
				...
				description:
					'한국 표준 시험지 머리글을 추가합니다 (학년도, 학년, 과목, 교시)',
				action: '시험지 머리글을 서식 지정합니다',
			},
			{
				name: '탭 정지 추가',
				value: 'addTabStops',
				description: '수평 텍스트 정렬을 위한 사용자 정의 탭 정지를 추가합니다',
				action: '탭 정지를 추가합니다',
			},
			{
				name: '차트 생성',
				value: 'generateChart',
				description:
					'SVG 차트/그래프를 생성합니다 (함수 그래프, 삼각형, 원, 사각형)',
				action: '차트를 생성합니다',
			},
			{
				name: '메모 추가',
				value: 'addMemo',
				description: 'HWPX 문서에 메모/주석을 추가합니다',
				action: '메모 주석을 추가합니다',
			},
			{
				name: '도형 추가',
				value: 'addShape',
				description: 'HWPX 문서에 그리기 도형(선, 사각형, 타원)을 삽입합니다',
				action: '도형 객체를 추가합니다',
			},
			{
				name: '변경 추적',
				value: 'trackChanges',
				description: 'HWPX 문서의 변경 추적을 읽기, 활성화 또는 비활성화합니다',
				action: '변경 추적을 관리합니다',
			},
			{
				name: '스타일로 치환',
				...
				description:
					'스타일(굵게, 기울임, 밑줄, 색상, 글꼴 크기)로 필터링하여 텍스트를 치환합니다',
				action: '스타일별로 텍스트를 치환합니다',
			},
			{
				name: '각주/미주 추가',
				value: 'addNote',
				description: 'HWPX 문서에 각주 또는 미주를 삽입합니다',
				action: '각주 또는 미주를 추가합니다',
			},
			{
				name: '북마크 추가',
				value: 'addBookmark',
				description: '상호 참조를 위한 북마크 마커를 삽입합니다',
				action: '북마크를 추가합니다',
			},
			{
				name: '워터마크 추가',
				value: 'addWatermark',
				description: '문서 내용 뒤에 텍스트 워터마크 오버레이를 추가합니다',
				action: '워터마크를 추가합니다',
			},
			{
				name: '문서 보호',
				value: 'setPassword',
				description:
					'읽기 전용 보호 설정, 보호 해제 또는 보호 상태를 확인합니다',
				action: '문서 보호를 관리합니다',
			},
			{
				name: 'Markdown 변환',
				value: 'toMarkdown',
				description: 'HWPX 문서 내용을 Markdown 형식으로 변환합니다',
				action: 'Markdown',
			},
		],
		default: 'replaceText',
